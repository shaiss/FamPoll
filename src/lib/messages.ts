...
export type Messages = {
  ...
  mgroupYourGroups: string;
  mgroupGroupLabel: string;
  mgroupManagePeople: string;
  mgroupNewOrJoin: string;
  familyAddFromOtherGroups: string;
  familyAddFromOtherGroupsHint: string;
  familyInGroups: string;
  familyAddPersonButton: string;
  familyAddGroupTitle: string;
  familyAddGroupSubtitle: string;
  familyCreateGroupButton: string;
  errFamGroupGone: string;
  errFamNotInGroup: string;
  errFamOrganizerOnlyAddPeople: string;
  errFamAlreadyHere: string;
...
const en: Messages = {
  ...
  familybackHome: "Home",
  familyintroSubtitle: "Everyone in this group can vote on its events.",
  ...
  familyleave: "Leave this group",
  familyrenameFamilyLabel: "Rename the group",
  familysaveName: "Save name",
  familydeleteToggle: "Delete this group…",
  familydeleteConfirm: "Delete {family} and every event, decision and vote in it. This can't be undone.",
  familydeleteButton: "Delete the whole group",
  ...
  pubGoToYourFamily: "Go to your groups",
  pubHome: "Home",
  ...
  errFampersonNotInFamily: "That person is not in this group.",
  ...
  errFamneedOneOrganizerDemote: "Make someone else an organizer first — a group needs one.",
  errFamorganizerOnlyMoveSeat: "Only an organizer can move a seat.",
  errFamhandToOrganizer: "Hand it to another organizer.",
  errFamorganizerOnlyDeleteFamily: "Only an organizer can delete the group.",
  ...
  mgroupYourGroups: "Your groups",
  mgroupGroupLabel: "Group",
  mgroupManagePeople: "Manage people",
  mgroupNewOrJoin: "New or join a group",
  familyAddFromOtherGroups: "Add from your other groups",
  familyAddFromOtherGroupsHint: "People you already share a group with. Adding them gives them a seat here straight away — no invite link needed.",
  familyInGroups: "In {groups}",
  familyAddPersonButton: "Add",
  familyAddGroupTitle: "Add a group",
  familyAddGroupSubtitle: "Start a new group, or join one with an invite code. You can switch between your groups any time.",
  familyCreateGroupButton: "Create group",
  errFamGroupGone: "That group is gone.",
  errFamNotInGroup: "You're not in that group.",
  errFamOrganizerOnlyAddPeople: "Only an organizer can add people.",
  errFamAlreadyHere: "You're already here.",
...
const es: Messages = {
  ...
  familyintroSubtitle: "Todos en este grupo pueden votar en sus eventos.",
  ...
  familyleave: "Salir de este grupo",
  familyrenameFamilyLabel: "Cambiar el nombre del grupo",
  familysaveName: "Guardar nombre",
  familydeleteToggle: "Eliminar este grupo…",
  familydeleteConfirm: "Eliminar {family} y todos sus eventos, decisiones y votos. Esto no se puede deshacer.",
  familydeleteButton: "Eliminar todo el grupo",
  familynewTitle: "¿Quiénes deciden juntos?",
  familynewSubtitle: "Crea tu primer grupo y luego envíale a todos un solo enlace de invitación.",
  familynameFieldLabel: "Nombre del grupo",
  familynamePlaceholder: "Los García",
  familystartButton: "Crear el grupo",
  ...
  familyjoinCodePlaceholder: "abcd2345",
  familyjoinButton: "Unirte a un grupo",
  ...
  pubGoToYourFamily: "Ir a tus grupos",
  pubHome: "Inicio",
  ...
  errFampersonNotInFamily: "Esa persona no está en este grupo.",
  ...
  errFamneedOneOrganizerDemote: "Primero haz organizador a otra persona: un grupo necesita uno.",
  errFamorganizerOnlyMoveSeat: "Solo un organizador puede mover un lugar.",
  errFamhandToOrganizer: "Pásalo a otro organizador.",
  errFamorganizerOnlyDeleteFamily: "Solo un organizador puede eliminar el grupo.",
  ...
  mgroupYourGroups: "Tus grupos",
  mgroupGroupLabel: "Grupo",
  mgroupManagePeople: "Gestionar personas",
  mgroupNewOrJoin: "Crear o unirte a un grupo",
  familyAddFromOtherGroups: "Agregar desde tus otros grupos",
  familyAddFromOtherGroupsHint: "Personas con las que ya compartes un grupo. Al agregarlas obtienen un lugar aquí de inmediato, sin enlace de invitación.",
  familyInGroups: "En {groups}",
  familyAddPersonButton: "Agregar",
  familyAddGroupTitle: "Agregar un grupo",
  familyAddGroupSubtitle: "Crea un grupo nuevo o únete a uno con un código de invitación. Puedes cambiar entre tus grupos cuando quieras.",
  familyCreateGroupButton: "Crear grupo",
  errFamGroupGone: "Ese grupo ya no existe.",
  errFamNotInGroup: "No estás en ese grupo.",
  errFamOrganizerOnlyAddPeople: "Solo un organizador puede agregar personas.",
  errFamAlreadyHere: "Ya estás aquí.",
...
const ptBR: Messages = {
  ...
  familyintroSubtitle: "Todo mundo neste grupo pode votar nos eventos dele.",
  ...
  familyleave: "Sair deste grupo",
  familyrenameFamilyLabel: "Renomear o grupo",
  familysaveName: "Salvar nome",
  familydeleteToggle: "Excluir este grupo…",
  familydeleteConfirm: "Excluir {family} e todos os eventos, decisões e votos dela. Isso não pode ser desfeito.",
  familydeleteButton: "Excluir o grupo inteiro",
  familynewTitle: "Quem decide junto?",
  familynewSubtitle: "Comece seu primeiro grupo e depois envie a todos um único link de convite.",
  familynameFieldLabel: "Nome do grupo",
  familynamePlaceholder: "Os Silva",
  familystartButton: "Começar o grupo",
  familyjoinCodeLabel: "Tem um código de convite?",
  familyjoinCodeHint: "É a última parte do link de convite que alguém te enviou.",
  familyjoinCodePlaceholder: "abcd2345",
  familyjoinButton: "Entrar em um grupo",
  ...
  pubGoToYourFamily: "Ir para seus grupos",
  pubHome: "Início",
  ...
  errFampersonNotInFamily: "Essa pessoa não está neste grupo.",
  ...
  errFamneedOneOrganizerDemote: "Primeiro torne outra pessoa organizadora — todo grupo precisa de um.",
  errFamorganizerOnlyMoveSeat: "Só um organizador pode mover um lugar.",
  errFamhandToOrganizer: "Passe para outro organizador.",
  errFamorganizerOnlyDeleteFamily: "Só um organizador pode excluir o grupo.",
  ...
  mgroupYourGroups: "Seus grupos",
  mgroupGroupLabel: "Grupo",
  mgroupManagePeople: "Gerenciar pessoas",
  mgroupNewOrJoin: "Criar ou entrar em um grupo",
  familyAddFromOtherGroups: "Adicionar dos seus outros grupos",
  familyAddFromOtherGroupsHint: "Pessoas com quem você já compartilha um grupo. Ao adicioná-las, elas ganham um lugar aqui na hora — sem link de convite.",
  familyInGroups: "Em {groups}",
  familyAddPersonButton: "Adicionar",
  familyAddGroupTitle: "Adicionar um grupo",
  familyAddGroupSubtitle: "Crie um novo grupo ou entre em um com um código de convite. Você pode alternar entre seus grupos quando quiser.",
  familyCreateGroupButton: "Criar grupo",
  errFamGroupGone: "Esse grupo não existe mais.",
  errFamNotInGroup: "Você não está nesse grupo.",
  errFamOrganizerOnlyAddPeople: "Só um organizador pode adicionar pessoas.",
  errFamAlreadyHere: "Você já está aqui.",
